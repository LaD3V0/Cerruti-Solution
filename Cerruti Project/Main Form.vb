...
Public Class frmMain
    ...
    Private Sub ClearOutput(sender As Object, e As EventArgs) _
        Handles cboAllowances.TextChanged, lstHours.SelectedIndexChanged,
        lstRates.SelectedIndexChanged, radMarried.TextChanged, radSingle.CheckedChanged,
        txtName.TextChanged
    ...
    Private Sub frmMain_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        'Verify that user wants to exit the application

        Dim dlgButton As DialogResult
        dlgButton = MessageBox.Show("Do you want to exit?", "Cerruti Company",
